...
const SetupInputException_1 = require("@/Exceptions/SetupInputException");
class SetupInputModule {
    fetch() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!config) {
                throw new SetupInputException_1.NoValidSetupInputFoundException();
            }
            return config;
        });
    }
    fetchGithubActionsConfig() {
        try {
            return {
                kindle: {
...
exports.default = SetupInputModule;
//# sourceMappingURL=SetupInputModule.js.map